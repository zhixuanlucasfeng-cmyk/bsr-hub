...
const catalog: Listing[] = [
  { id:"ps5-slim", ownerId:"seller-demo", title:"PS5 Slim + Two Controllers", listingType:"rental", category:"Gaming", description:"Quiet, clean console with Spider-Man 2 and HDMI cable. Great for a weekend with friends.", city:"Wellesley", state:"MA", condition:"Like new", unitPriceCents:1200, depositCents:10000, deliveryFeeCents:800, billingUnit:"thirty_minutes", fulfillment:["pickup","delivery","owner_location"], accent:"#6d5dfc", icon:"🎮" },
  { id:"ps5-pro", ownerId:"seller-demo", title:"PS5 Pro Creator Setup", listingType:"rental", category:"Gaming", description:"High-performance console with headset and capture card for streams or tournaments.", city:"Newton", state:"MA", condition:"Excellent", unitPriceCents:1800, depositCents:15000, deliveryFeeCents:1200, billingUnit:"thirty_minutes", fulfillment:["pickup","delivery"], accent:"#8b5cf6", icon:"🕹️" },
  { id:"macbook", ownerId:"tech-demo", title:"MacBook Pro M2 14-inch", listingType:"rental", category:"Computers", description:"Portable editing and development laptop with charger and protective sleeve.", city:"Needham", state:"MA", condition:"Excellent", unitPriceCents:5200, depositCents:20000, deliveryFeeCents:1000, billingUnit:"day", fulfillment:["pickup","delivery"], accent:"#0ea5e9", icon:"💻" },
  { id:"gaming-pc", ownerId:"tech-demo", title:"RTX Gaming & Rendering PC", listingType:"rental", category:"Computers", description:"RTX 4070 desktop for gaming, 3D work, and short production projects.", city:"Waltham", state:"MA", condition:"Very good", unitPriceCents:6800, depositCents:25000, deliveryFeeCents:1800, billingUnit:"day", fulfillment:["delivery","owner_location"], accent:"#06b6d4", icon:"🖥️" },
  { id:"sony-camera", ownerId:"creator-demo", title:"Sony A7 IV Camera Kit", listingType:"rental", category:"Cameras", description:"Full-frame camera, 28–70mm lens, batteries, SD card, and compact tripod.", city:"Brookline", state:"MA", condition:"Excellent", unitPriceCents:7500, depositCents:30000, deliveryFeeCents:1200, billingUnit:"day", fulfillment:["pickup","delivery"], accent:"#f97316", icon:"📷" },
  { id:"podcast-kit", ownerId:"creator-demo", title:"Two-Person Podcast Kit", listingType:"rental", category:"Cameras", description:"Two microphones, audio interface, table arms, headphones, and cables.", city:"Boston", state:"MA", condition:"Good", unitPriceCents:4200, depositCents:12000, deliveryFeeCents:1000, billingUnit:"day", fulfillment:["pickup","delivery"], accent:"#fb7185", icon:"🎙️" },
  { id:"tool-set", ownerId:"maker-demo", title:"Cordless Home Project Tool Set", listingType:"rental", category:"Tools", description:"Drill, driver, sander, batteries, safety glasses, and organized case.", city:"Dedham", state:"MA", condition:"Good", unitPriceCents:2800, depositCents:8000, deliveryFeeCents:900, billingUnit:"day", fulfillment:["pickup","delivery"], accent:"#f59e0b", icon:"🛠️" },
  { id:"laser-cutter", ownerId:"maker-demo", title:"Desktop Laser Cutter Session", listingType:"workspace", category:"Maker space", description:"Supervised laser cutter and ventilation station. Materials charged separately.", city:"Cambridge", state:"MA", condition:"Professional", unitPriceCents:2200, depositCents:0, deliveryFeeCents:0, billingUnit:"thirty_minutes", fulfillment:["on_site"], accent:"#eab308", icon:"⚙️" },
  { id:"photo-studio", ownerId:"seller-demo", title:"Natural-Light Photo Studio", listingType:"workspace", category:"Studio", description:"500 sq ft studio with backdrops, lights, changing area, and freight elevator.", city:"Boston", state:"MA", condition:"Professional", unitPriceCents:3500, depositCents:5000, deliveryFeeCents:0, billingUnit:"thirty_minutes", fulfillment:["on_site"], accent:"#ec4899", icon:"🎬" },
  { id:"print-shop", ownerId:"business-demo", title:"Small-Batch Print Workshop", listingType:"workspace", category:"Printing", description:"Book presses, cutters, worktables, and help from an experienced operator.", city:"Somerville", state:"MA", condition:"Professional", unitPriceCents:3000, depositCents:0, deliveryFeeCents:0, billingUnit:"thirty_minutes", fulfillment:["on_site"], accent:"#14b8a6", icon:"🖨️" },
  { id:"monitor-sale", ownerId:"tech-demo", title:"Used 27-inch 4K Monitor", listingType:"sale", category:"Second-hand", description:"Color-accurate display with stand and cables. Small cosmetic mark on rear shell.", city:"Newton", state:"MA", condition:"Very good", unitPriceCents:16500, depositCents:0, deliveryFeeCents:1500, billingUnit:"day", fulfillment:["pickup","delivery"], accent:"#3b82f6", icon:"🖥️" },
